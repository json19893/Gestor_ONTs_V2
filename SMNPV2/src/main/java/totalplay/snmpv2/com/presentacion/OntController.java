...
public class OntController {
    ...
    @RequestMapping(value = "/limpieza/onts/repetidas/{idOlt}", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
    public ResponseEntity<PostMetricaResponse> obtenerOntsRepetidas(@PathVariable("idOlt") Integer idOlt) {
