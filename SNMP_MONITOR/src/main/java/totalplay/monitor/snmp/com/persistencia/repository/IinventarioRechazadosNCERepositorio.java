...
public interface IinventarioRechazadosNCERepositorio extends MongoRepository<InventarioRechazadasNCEEntidad, String> {
	...
	@Aggregation(pipeline = { 
			  ...
			  , "{\r\n"
			  + "		\"$lookup\":{\r\n"
			  + "			from: \"tb_inventario_onts_tmp_nce\",\r\n"
			  + "			localField:\"id_olt\",\r\n"
			  + "			foreignField:\"id_olt\",\r\n"
	...
	List<AceptadasNCEDto> getRechazadasNCEInventario(@Param("ip") String ip, @Param("olt") Integer olt, @Param("fechInicial") Date fechaInicial,  @Param("fechaFinal") Date fechaFinal );
