...
@Repository
public interface IpoleoLastUpTimeRepositorio extends MongoRepository<poleosLastUpTimeEntidad, String> {
	//@Query(value="{'id_ejecucion': ?0, 'id_olt': ?1, 'oid': ?2, }", sort="{_id:-1}", )
