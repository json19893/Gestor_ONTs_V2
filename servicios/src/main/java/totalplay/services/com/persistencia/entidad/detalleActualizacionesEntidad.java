...
public class detalleActualizacionesEntidad {
	...
	public String getCausaRecibida() {
		return causaRecibida;
	}
	public void setCausaRecibida(String causaRecibida) {
		this.causaRecibida = causaRecibida;
	}
