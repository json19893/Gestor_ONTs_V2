...
var DrawingSeries = /** @class */ (function (_super) {
        ...
        value: function (index) {
            ...
            if (dataItems) {
                $object.each(dataItems, function (_key, dataItem) {
                    _this.data.removeValue(dataItem.dataContext);
                });
            }
        }
    });
    ...
    Object.defineProperty(DrawingSeries.prototype, "showAllBullets", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
    ...
    Object.defineProperty(DrawingSeries.prototype, "_setXLocationReal", {
        ...
        value: function (dataItem, value) {
            ...
            var open = $time.round(new Date(value), baseInterval.timeUnit, baseInterval.count, firstDayOfWeek, root.utc).getTime();
            var close = open + $time.getDuration(baseInterval.timeUnit, baseInterval.count * 1.1);
