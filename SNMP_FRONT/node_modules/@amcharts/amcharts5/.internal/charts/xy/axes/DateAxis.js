            ...
            $array.each(fields, function (field) {
                ...
                if ($type.isNumber(value)) {
                    ...
                    if (value >= startTime && value <= endTime) {
                        ...
                        endTime = $time.round(new Date(endTime), baseInterval.timeUnit, baseInterval.count, _this._root.locale.firstDayOfWeek, _this._root.utc, undefined, _this._root.timezone).getTime();
